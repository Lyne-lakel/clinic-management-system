...
exports.addPatient = async (req, res) => {
    try {
        ...
        await logAction(req, 'Admin', 'Admin', `Registered new patient: ${firstName} ${lastName}`);
...
exports.updatePatient = async (req, res) => {
    try {
        ...
        await logAction(req, 'Admin', 'Admin', `Updated record for patient: ${updated.firstName} ${updated.lastName}`);
...
exports.deletePatient = async (req, res) => {
    try {
        ...
        await logAction(req, 'Admin', 'Admin', `Deleted patient record: ${patient.firstName} ${patient.lastName}`);
